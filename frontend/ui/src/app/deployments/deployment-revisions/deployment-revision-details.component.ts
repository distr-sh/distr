...
import {DeploymentRevisionResponse, DeploymentType} from '@distr-sh/distr-sdk';
...
@Component({
  ...
  imports: [ReactiveFormsModule, EditorComponent, FaIconComponent, DatePipe],
})
export class DeploymentRevisionDetailsComponent {
  public readonly revision = input.required<DeploymentRevisionResponse>();
  public readonly deploymentType = input.required<DeploymentType>();
