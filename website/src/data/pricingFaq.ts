...
export const PricingFAQs: PricingFAQ[] = [
...

  {
    ...
    answer:
      'Most teams ship their first customer install right after our onboarding. We support GitHub release automation, pre/post install scripts, and agent based distributions out of the box. To make sure you get unlocked fast — all plans include white glove onboarding.',
  },
  {
    id: 'self-hosting',
