...
faq:
  - question: "Does the CRA require automatic updates for B2B software?"
    answer: "No. Automatic security updates with opt-out are the default expectation for consumer products. Recital 56 recognizes that professional and industrial environments manage updates through their own change processes. You must still distribute updates securely and notify users."
  ...
  - question: "Do we have to keep old patches available?"
    answer: "Yes. Article 13(9): each security update issued during the support period stays available for at least 10 years or the remainder of the support period, whichever is longer."
  - question: "Is emailing customers a zip file compliant?"
    answer: "Email is neither authenticated nor integrity-protected, and gives you no delivery evidence. With signed artifacts and a documented verification step you might defend it; as a mechanism it fails the spirit of Annex I Part II (7) and will not survive a serious security review by your own customers."
  - question: "What goes in the technical documentation?"
    answer: "Annex VII requires a description of the technical solutions chosen for the secure distribution of updates: your channel, your signing scheme, your verification steps, your advisory process, and your air-gap path if you have one."
---
...
self-hosted customers. Annex I, Part II, point (7) requires manufacturers to
...
solution in writing: Annex VII requires the technical documentation to include
...
|---|---|---|
| Secure distribution mechanism | Annex I Part II (7) | An authenticated, integrity-protected way for every customer to get updates |
| Dissemination without delay, with advisories | Annex I Part II (8) | You notify customers when a security update exists and tell them what to do |
| Security updates separate from feature updates | Annex I Part II (2) | Customers can take the patch without taking the new features, where technically feasible |
| Updates stay available for 10 years | Article 13(9) | Every security update remains downloadable for 10 years or the rest of the support period, whichever is longer |
...
the automatic-update default in Annex I Part I is aimed at consumer products, and
Recital 56 explicitly carves out products intended for professional ICT and
...
- **Sign your artifacts and publish the verification path.** Cosign signatures on
  container images, GPG on packages, or a TUF-style metadata layer. Annex VII
...
- **Tag security releases as security releases.** The separation requirement in
  Annex I Part II (2) means a customer on 2.3 should be able to get 2.3.1 with
...
- **Consider deployment agents for managed rollouts.** A lightweight agent in
  ...
  exactly what Recital 56 expects for professional environments.
...
Annex I Part II (8) does not just say ship the patch. It says security updates
...
4. **Precision about versions.** "Please update to the latest version" is not
   ...
   lets an operator act in minutes and is the wording Annex I Part II (4)
   expects for public disclosure anyway.
...
3. **Document the transfer workflow** the customer uses: approved media,
   ...
   their deployments pull from. You don't control this part, but your Annex VII
...
5. **Record what you made available and when.** Inside the gap you cannot prove
   ...
   Annex I Part II your duty is to distribute and disseminate; if a business
...
days after the patch is available (Article 14). Somewhere in that window, someone
will ask which customers are affected.
