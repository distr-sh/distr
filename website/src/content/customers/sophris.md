...
person:
  name: 'Ansh Gupta'
  role: 'CTO'
  image: '/src/assets/customers/sophris/ansh-gupta.jpeg'
quote: 'Distr eliminated nearly all deployment headaches. Updates that used to take days now take minutes.'
industry: 'AI/Engineering Tools'
useCase: 'Enterprise PoC'
featured: true
outcome: 'Updates that took days now take minutes'
caseStudy:
  logo: '/src/assets/customers/sophris/logo.png'
  pageTitle: 'Sophris.ai Case Study'
  pageDescription: 'How Sophris.ai uses Distr to streamline on-premises software distribution'
---
...
"**At the start, we would send zip files directly to the customer IT team,**" says Ansh Gupta, CTO at Sophris. "**Often, simple mistakes, like not extracting a file correctly, caused significant deployment delays, draining our resources and affecting our speed. We needed a better way.**"
