...
and report deployment status, logs, and health to both the [vendor](/docs/vendor-portal/) and [customer](/docs/customers/) portals,
...
1. Create Your [Application](/docs/agents/create-application/)
...
6. Customer deploys your application via the Distr [agents](/docs/customers/customer-registry-access/#deployment-agent-quickstart-from-the-customer-portal)
