...
description: Deploy Distr agents to IoT devices and specialized hardware, once installed, each edge device can be centrally managed and monitored via the vendor portal.
slug: docs/use-cases/edge-deployments
sidebar:
