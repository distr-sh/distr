...
import airGappedLight from '~/assets/docs/getting-started/distribution-scenarios/air-gapped/air-gapped-light.png';
import airGappedDark from '~/assets/docs/getting-started/distribution-scenarios/air-gapped/air-gapped-dark.png';
