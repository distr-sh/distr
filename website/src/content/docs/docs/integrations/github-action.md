...
slug: docs/integrations/github-action
sidebar:
  order: 5
---
...
See the **[Automatic Deployments from GitHub](/docs/guides/github-actions/)** guide.
...
- [Personal Access Tokens](/docs/integrations/access-tokens/) - How to create API tokens
