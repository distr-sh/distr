...
| **Deployment** | The deployment target whose agent performed the pull, linked to its detail page |
...
<Aside type="note">
  ...
  instead; the customer organization is taken from that deployment target.
</Aside>
