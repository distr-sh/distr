...
- The [customer portal](/docs/customers/customer-registry-access/#registry-quickstart-from-the-customer-portal) provides a simplified view, the registry UI only shows the artifacts and versions that are accessible to the user.
