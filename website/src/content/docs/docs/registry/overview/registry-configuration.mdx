...
slug: docs/registry/push-to-registry
sidebar:
  order: 2
---
...
- The [customer portal](/docs/platform/container-registry-for-end-customers/#registry-quickstart-from-the-customer-portal) provides a simplified view, the registry UI only shows the artifacts and versions that are accessible to the user.
