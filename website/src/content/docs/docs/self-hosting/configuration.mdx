...
| `SUPPORT_BUNDLE_LOG_TAIL_LINES`     | no       | —         | Additionally limits container logs to this number of lines per container. If unset, all lines are collected, up to `SUPPORT_BUNDLE_RESOURCE_MAX_BYTES`. |
