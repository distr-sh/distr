...
**Vendor:** Open the license key from the customer's detail view and click the **view** (eye) icon. Distr generates the token and displays it, so you can copy it to deliver to your customer.
...
```shell
curl https://your-distr.example.com/api/public/v1/license-keys/public-key
```
