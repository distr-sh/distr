...
<Aside type="note">
  ...
  customer](/docs/customers/manage-customers/#enabling-and-disabling-features-per-customer).
</Aside>
...
Support Bundles must be enabled per customer organization before customers can create bundles. See [Enabling features per customer](/docs/customers/manage-customers/#enabling-and-disabling-features-per-customer) for how to do this.
