...
slug: docs/platform/container-registry-for-end-customers
sidebar:
  order: 2
---
...
import customerAgentNameLight from '~/assets/docs/platform/customer-portal/customer-view/customer-agent-name-light.png';
import customerAgentNameDark from '~/assets/docs/platform/customer-portal/customer-view/customer-agent-name-dark.png';
import helmNSLight from '~/assets/docs/platform/customer-portal/customer-view/helm-ns-light.png';
import helmNSDark from '~/assets/docs/platform/customer-portal/customer-view/helm-ns-dark.png';
import configLight from '~/assets/docs/platform/customer-portal/customer-view/config-light.png';
import configDark from '~/assets/docs/platform/customer-portal/customer-view/config-dark.png';
