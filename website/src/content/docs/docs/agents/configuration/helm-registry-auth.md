---
title: Helm Chart Registry Authentication
...
Distr requires authentication to access the registry API, but our agents can inject the relevant credentials where they are needed.
