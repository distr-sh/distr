...
<Aside type="caution">
  Updating the environment template will not update the environment file for
  existing deployments. Existing deployments will need to add the new variables
  manually when they release a new version.
</Aside>
