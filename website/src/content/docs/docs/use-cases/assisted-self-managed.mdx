...
The lightweight and open source [Distr agents](/docs/platform/agents/), installed by the customer in the target environment, handle deployments and updates.
They pull application definitions and artifacts from the Distr Hub, apply customer-defined configurations,
and report deployment status, logs, and health to both the [vendor](/docs/platform/vendor-portal/) and [customer](/docs/platform/customer-portal/) portals,
...
1. Create Your [Application](/docs/guides/create-application/)
2. (Optional) Set Up Your [Registry](/docs/guides/push-to-registry/)
...
5. Customer creates a [Personal Access token](/docs/integrations/access-tokens/)
6. Customer deploys your application via the Dist [agents](/docs/guides/customer-registry-access/#deployment-agent-quickstart-from-the-customer-portal)
