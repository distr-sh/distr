...
Distr provides distribution tooling for [self-managed](/docs/use-cases/fully-self-managed/), [BYOC](/docs/use-cases/byoc/), [air-gapped](/docs/use-cases/air-gapped/),
and [edge deployments](/docs/use-cases/edge/) while giving vendors visibility and control throughout the application lifecycle.
...
| 🛠️ **Works with existing tools**     | Distr integrates with Docker, Helm, and all OCI-compliant tools as well as [GitHub Actions](/docs/integrations/github-action/) fitting easily into established workflows. |
| 🔒 **Built for enterprise security** | Supports air-gapped environments and [token based](/docs/integrations/access-tokens/) private registry access                                                             |
...
| 📋 **Deployment flexibility**        | Available as both a managed SaaS and a [self-hosted](/docs/self-hosting/overview/) solution                                                                               |
| 📱 **Dual portal system**            | Vendor Portal for complete control and Customer Portal for simplified, [white-labeled](/docs/customers/branding/) end-customer access.                                     |
