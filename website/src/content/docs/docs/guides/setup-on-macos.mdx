...
slug: docs/agents/setup-on-macos
sidebar:
  order: 0
---
...
<Aside type="note">
  ...
  the [Distr agents](/docs/agents/). Since Distr can also be
...
To verify everything is configured correctly, try [creating a deployment](/docs/agents/create-deployment/) through Distr.
