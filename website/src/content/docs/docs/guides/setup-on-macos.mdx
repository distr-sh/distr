...
slug: docs/guides/setup-on-macos
sidebar:
  order: 0
---
...
<Aside type="note">
  ...
  the [Distr agents](/docs/platform/agents/). Since Distr can also be
...
To verify everything is configured correctly, try [creating a deployment](/docs/guides/create-deployment/) through Distr.
