...
slug: docs/agents/create-application
sidebar:
  order: 1
---
...
take a look at our [GitHub Action](/docs/integrations/github-action/) or [SDKs](/docs/integrations/sdk/).
...
Once you've created your application and added versions, you're ready to create deployments. See the [Create Deployment](/docs/agents/create-deployment/) guide for instructions on deploying your applications to customer environments.
