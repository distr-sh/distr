...
slug: docs/customers/customer-registry-access
sidebar:
  order: 7
---
...
As an end customer, you will be given access to a [Customer Portal](/docs/customers/) by the software vendor.
...
Refer to the deployment instructions in your [Customer Portal](/docs/customers/) dashboard or coordinate directly with your vendor for specific deployment guidance.
...
<Aside type="tip">
  ...
  limited to a specific namespace. See [Helm Agent](/docs/agents/helm-agent/)
  for more details.
</Aside>
