...
slug: docs/guides/customer-registry-access
sidebar:
  order: 7
---
...
Generate a [Personal Access Token (PAT)](/docs/integrations/access-tokens/) in your Distr account and use it to log in:
...
<Aside type="tip">
  ...
  Agent](/docs/platform/agents/#helm-agent) for more details.
</Aside>
