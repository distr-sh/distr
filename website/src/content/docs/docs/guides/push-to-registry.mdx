...
slug: docs/guides/push-to-registry
sidebar:
  order: 3
---
...
- The [customer portal](/docs/guides/customer-registry-access/#registry-quickstart-from-the-customer-portal) provides a simplified view, the registry UI only shows the artifacts and versions that are accessible to the user.
