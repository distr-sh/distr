...
Generate a [Personal Access Token (PAT)](/docs/integrations/access-tokens/) in your Distr account. Use this token to log in to the registry:
...
- Customers should authenticate with their own [PAT](/docs/integrations/access-tokens/) and can only pull artifacts they are licensed for.
