...
slug: docs/guides/k8s-compatibility
sidebar:
  order: 8
---
...
2. A Helm application configured in Distr (see [Create Application](/docs/guides/create-application/))
3. A GitHub repository containing your Helm chart
4. The [Automatic Deployments from GitHub](/docs/guides/github-actions/) workflow already configured — this guide extends that pipeline with a compatibility validation stage
...
- **[Automatic Deployments from GitHub](/docs/guides/github-actions/)** — If you haven't already, set up automatic version creation and deployment updates
...
- **[Configuring Helm Charts for Distr](/docs/guides/helm-registry-auth/)** — Set up authenticated image pulls with imagePullSecrets
