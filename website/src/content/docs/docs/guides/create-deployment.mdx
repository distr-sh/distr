...
slug: docs/guides/create-deployment
sidebar:
  order: 2
---
...
This step-by-step guide shows you how to create deployments for Docker and Helm applications in Distr. Before creating a deployment, make sure you've already [created an application](/docs/guides/create-application/) with at least one version. The deployment flow guides you through selecting a customer, choosing an application, configuring deployment settings, and obtaining the command to install both the Distr agent and your application.
...
For more information on how to use them, please refer to [our guide on working with environment variables](/docs/guides/docker-env/).

You can also enable Docker Swarm mode for deployments that should run in swarm mode. See [Docker Swarm](/docs/platform/agents/#docker-swarm) for more details. Additionally, you can enable container log collection to view application logs directly in the portal. Learn more about [Container Logs](/docs/platform/logs-and-metrics/#container-logs).
...
You can also enable cluster-scoped permissions. When enabled, the agent will have cluster-wide access; otherwise, it will be limited to a specific namespace. See [Helm Agent](/docs/platform/agents/#helm-agent) for more details about cluster-scoped vs namespace-scoped agents.
...
- [Create a Application](/docs/guides/create-application/) - Learn how to create Docker and Helm applications
- [Application Entitlements](/docs/guides/application-entitlements/) - Control which applications customers can access
- [Docker Environment Variables](/docs/guides/docker-env/) - Configure environment variable templates
- [Helm Chart Registry Auth](/docs/guides/helm-registry-auth/) - Set up authenticated image pulls
