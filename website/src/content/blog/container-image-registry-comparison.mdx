...
[Distr](/) comes with an OCI-compliant [artifact registry](/docs/platform/registry/) natively built into the platform.

Distr itself is [fully open source on GitHub](https://github.com/distr-sh/distr/) and can be self-hosted.
It not only features a [vendor portal](/docs/platform/vendor-portal/) that allows software and AI companies to manage their artifacts,
...
It also comes with a [customer portal](/docs/platform/customer-portal/) where end customers see all available artifacts and can create access tokens to interact with the registry.
...
- It can be consumed as a managed service (SaaS).
  (Sign up at [Get Started](/get-started/)) or [self-managed](/docs/self-hosting/overview/).
