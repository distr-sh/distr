...
description: '12 container registries compared: Docker Hub, ECR, Google AR, ACR, Harbor, JFrog, GitHub, GitLab + 4 more. Pricing, self-hosting, open source, and scale.'
...
- Available as a managed service (SaaS) via [Get Started](/get-started/), or [self-hosted](/docs/self-hosting/)
...
- **Commercial open source and SaaS vendors that want to offer self-hosted deployment options.** **[Distr](/)** is built for software vendors distributing artifacts into external customer environments, including regulated, self-hosted, and air-gapped deployments. Granular access controls, usage tracking, and flexible deployment models that internal or public registries don't provide.
