...
It not only features a [vendor portal](/docs/vendor-portal/) that allows software and AI companies to manage their artifacts,
...
- It can be consumed as a managed service (SaaS).
  (Sign up at [Get Started](/get-started/)) or [self-managed](/docs/self-hosting/).
