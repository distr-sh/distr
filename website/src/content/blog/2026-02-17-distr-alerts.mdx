...
For customers that manage and update the [deployments](/docs/agents/) themselves, you can enable alerts for them as well so they can configure their own alerts in the [Customer portal](/docs/customers/).
