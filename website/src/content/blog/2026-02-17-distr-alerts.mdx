...
Distr lets you configure alerts in the [Vendor portal](/docs/platform/vendor-portal/). Set them once, they apply everywhere. Or get granular if you want.

For customers that manage and update the [deployments](/docs/platform/agents/) themselves, you can enable alerts for them as well so they can configure their own alerts in the [Customer portal](/docs/platform/customer-portal/).
...
The details on setting this up are in the [alerts documentation](/docs/platform/alerts/).
