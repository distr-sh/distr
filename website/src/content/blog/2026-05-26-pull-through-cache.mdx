...
After: Here is your registry endpoint and a token.
...
That is the entire interaction. The credential you give them is scoped to the specific artifacts they are entitled to. When they churn, you revoke the token instead of hunting down their IAM user in your AWS account.
