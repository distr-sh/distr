...
description: 'Distr now collects container logs and system metrics from every connected customer deployment and surfaces them in your vendor portal without SSH, screen sharing, or waiting.'
...
If you're not using Distr yet and you ship software to [on-prem](/glossary/on-premises-definition/) or [self-hosted](/glossary/self-hosted-software/) environments, this is a good place to start. [Try it here](https://distr.sh/onboarding).
