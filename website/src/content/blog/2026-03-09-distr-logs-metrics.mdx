...
The details — resource labeling, time-range filtering, log export format, Kubernetes metrics-server requirements — are all in the [agents documentation](/docs/platform/agents/).
