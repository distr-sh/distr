...
I am Philip, an engineer working at Glasskube, which helps [software and AI companies](/glossary/isv-meaning/) distribute their applications to [self-hosted environments](/glossary/self-hosted-software/).
...
With the recent [introduction of our container registry](/docs/registry/) we are now also supporting
...
We extended our agent to not only reconcile the application deployment but also collect metrics from the target when configured.

Read more about [Metrics Collection](/docs/agents/logs-and-metrics/#metrics) in our documentation.
...
**Is anything missing?**
You can try out our new dashboard yourself by signing up for a free Distr account at [Get Started](/onboarding/).
