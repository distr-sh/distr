...
With the recent [introduction of our container registry](/docs/platform/registry/) we are now also supporting
...
Read more about [Metrics Collection](/docs/platform/logs-and-metrics/#metrics) in our documentation.
