...
We've seen a clear jump in inbound and interest around [self-hosted](/glossary/self-hosted-software/), [on-prem](/glossary/on-premises-definition/), and [BYOC](/glossary/byoc-definition/). The same conversations showing up again and again with B2B and AI startups selling into enterprises. We wanted to put numbers behind that sentiment and explain publicly **why** this is happening.
...
And when someone asks for self-hosted, get clear on what they actually mean. BYOC, customer-operated, air-gap: different points on the same map. Read our article on [the self-hosted spectrum](/blog/self-hosted-spectrum/), where we walk through that whole range.
