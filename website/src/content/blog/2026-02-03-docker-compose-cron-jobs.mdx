...
Cron jobs are one of several Compose gaps worth knowing about—I have collected the rest in [Running Docker in Production: Quirks and How to Handle Them](/blog/running-docker-in-production/).
