...
I am Philip, an engineer working at Glasskube. We are building an Open Source control plane for self-hosted, BYOC, and on-prem deployments.
Everything you need to distribute applications to self-hosted customers out of the box is called Distr
...
To first introduce core conceptual aspects relating to self-hosted deployments and Distr more generally,
...
<div
  className="app-frame mac dark borderless shadow--tl"
  data-url="distr.sh/docs/registry/">
  ![Screenshot of the Distr
...
<div
  className="app-frame mac dark borderless shadow--tl"
  data-url="distr.sh/docs/vendor-portal/">
