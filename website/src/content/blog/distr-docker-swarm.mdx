...
I am Jakob, an engineer working at Glasskube, which helps [software and AI companies](/glossary/isv-meaning/) distribute their applications to [self-hosted environments](/glossary/self-hosted-software/).
...
If you don't have an account yet, you can [sign up for free](/onboarding/).
...
If you want to learn more about Docker Swarm mode in Distr, definitely check out our [documentation](/docs/agents/docker-agent/#docker-swarm)!
