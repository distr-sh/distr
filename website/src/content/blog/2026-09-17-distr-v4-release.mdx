...
**Check your PostgreSQL and Docker versions.** Distr v4 requires PostgreSQL 18+. The Docker Compose stacks require Docker Engine 29+ with the [containerd image store](https://docs.docker.com/engine/storage/containerd/).
