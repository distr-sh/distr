...
1. Customer hits an issue and creates a support bundle from their [Customer Portal](/docs/customers/). They give it a title and describe what went wrong.
...
4. The bundle appears in your [Vendor Portal](/docs/platform/vendor-portal/) with all collected resources attached.
