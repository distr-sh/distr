...
The full setup is in the [Kubernetes Compatibility Matrix guide](/docs/guides/k8s-compatibility/). The [hello-distr](https://github.com/distr-sh/hello-distr) repository has a complete working example with all the scripts and a GitHub Actions workflow you can adapt.

If you're already using Distr with the [automatic deployments from GitHub](/docs/guides/github-actions/) workflow, this is a straightforward extension: three additional jobs in the same pipeline.
