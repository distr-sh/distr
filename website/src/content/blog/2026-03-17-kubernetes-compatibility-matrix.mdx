...
The full setup is in the [Kubernetes Compatibility Matrix guide](/docs/platform/k8s-compatibility/). The [hello-distr](https://github.com/distr-sh/hello-distr) repository has a complete working example with all the scripts and a GitHub Actions workflow you can adapt.
