...
If you are shipping software to [self-hosted](/glossary/self-hosted-software/) customers and do not want to build the distribution plumbing yourself, [try Distr free for 30 days](https://distr.sh/onboarding/).
