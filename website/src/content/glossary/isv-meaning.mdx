...
faq:
  ...
  - question: What challenges do ISVs face with self-hosted deployments?
...
ISVs have to distribute their software to customers across a growing range of deployment environments: public cloud marketplaces, [self-hosted](/glossary/self-hosted-software/) infrastructure, [on-premises](/glossary/on-premises-definition/) data centers, and [air-gapped](/glossary/air-gapped-meaning/) environments. Distribution has become one of the harder problems as customers demand more flexibility.
...
- **Certinia** (formerly FinancialForce), professional services automation
...
ISVs and SaaS get mixed up constantly, so the two are worth separating.
...
Customers want to run ISV software in their own AWS, Azure, or Google Cloud accounts ([BYOC, Bring Your Own Cloud](/glossary/byoc-definition/)) so they can control data residency, security policies, and cost.
...
[Software distribution platforms](/glossary/software-distribution-platform/) like **Distr** specialize in these distribution problems, providing:
...
- **[License management](/glossary/software-license-management/) system.** [Entitlement](/glossary/software-entitlement/) controls, seat management, feature flagging, and subscription-tier enforcement.
...
- **Scalability.** [Kubernetes](/glossary/kubernetes/) orchestrates containers for auto-scaling and high availability.
...
Distr is a software distribution platform built for ISVs that need to deploy software into customer-controlled environments, including [self-hosted](/glossary/self-hosted-software/) cloud, [on-premises](/glossary/on-premises-definition/) data centers, BYOC architectures, and [air-gapped](/glossary/air-gapped-meaning/) networks.
