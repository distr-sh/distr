...
SaaS suits businesses that don't require stringent control over data location, such as retail, professional services, and creative industries. As a deployment model, it is the most convenient and straightforward option, at the expense of user control. Organizations that need that control typically look at [self-hosted](/glossary/self-hosted-software/) options, including [BYOC](/glossary/byoc-definition/) and customer-operated deployments. [The self-hosted spectrum](/blog/self-hosted-spectrum/) covers how those postures relate.
