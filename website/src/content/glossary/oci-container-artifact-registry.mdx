...
Yes, self-hosted registries like Harbor, Distribution, and [Distr self-hosted](/docs/self-hosting/) can run entirely on-premises or in [air-gapped](/glossary/air-gapped-meaning/) environments with no internet connectivity. This is common in regulated industries and high-security deployments.
