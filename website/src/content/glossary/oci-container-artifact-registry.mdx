...
- **Commercial registries** - JFrog Artifactory, Cloudsmith, [Distr](/docs/platform/registry/)
...
Yes, self-hosted registries like Harbor, Distribution, and [Distr self-hosted](/docs/self-hosting/overview/) can run entirely on-premises or in [air-gapped](/glossary/air-gapped-meaning/) environments with no internet connectivity. This is common in regulated industries and high-security deployments.
...
Software vendors distributing commercial applications to external customers should use purpose-built registries like [Distr](/docs/platform/registry/) that provide customer-specific access controls, usage analytics, license management, and support for self-managed and [air-gapped](/glossary/air-gapped-meaning/) customer deployments. Standard internal registries lack these customer-facing capabilities.
...
- **Open source**: Available as [managed SaaS](/get-started/) or [self-hosted](/docs/self-hosting/overview/)
