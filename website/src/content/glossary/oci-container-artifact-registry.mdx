...
faq:
  ...
  - question: Can I run a registry on-premises or in an air-gapped environment?
    answer: 'Yes. Self-hosted registries like Harbor, Distribution, and Distr self-hosted can run entirely on-premises or in air-gapped environments with no internet connectivity. Common practice in regulated industries and high-security deployments.'
  ...
  - question: How do I choose between cloud-hosted and self-hosted registries?
    answer: 'Cloud-hosted registries (AWS ECR, Azure ACR, Distr) have minimal operational overhead, automatic updates, and pay-per-use pricing. Self-hosted registries (Harbor, Distribution) give you full control, work in air-gapped environments, and avoid cloud egress fees, at the cost of operational management.'
  - question: What is the best registry for software vendors distributing to customers?
    answer: 'Software vendors distributing commercial applications to external customers should use purpose-built registries like Distr, which provide customer-specific access controls, usage analytics, license management, and support for self-managed and air-gapped customer deployments.'
---
...
Tag the image with the registry URL: `docker tag myapp:latest registry.example.com/myapp:latest`. Authenticate: `docker login registry.example.com`. Push: `docker push registry.example.com/myapp:latest`.
...
Container registry security depends heavily on configuration. Best practices: use private registries with authentication, enable vulnerability scanning, implement image signing, configure role-based access control, use TLS/SSL encryption, and enable audit logging. A properly configured registry can be very secure.
...
Yes. Self-hosted registries like Harbor, Distribution, and [Distr self-hosted](/docs/self-hosting/) can run entirely on-premises or in [air-gapped](/glossary/air-gapped-meaning/) environments with no internet connectivity. Common practice in regulated industries and high-security deployments.

### What is OCI compliance and why does it matter?

OCI (Open Container Initiative) compliance means a registry follows standardized specifications for image format and distribution. That makes your images portable across OCI-compliant tools and registries, so you aren't locked to a single ecosystem.

### How do I choose between cloud-hosted and self-hosted registries?

Cloud-hosted registries (AWS ECR, Azure ACR, Distr) have minimal operational overhead, automatic updates, and pay-per-use pricing. Self-hosted registries (Harbor, Distribution) give you full control, work in [air-gapped](/glossary/air-gapped-meaning/) environments, and avoid cloud egress fees, at the cost of operational management. The right answer depends on your team's operational capacity, your security requirements, and your broader infrastructure strategy.

### What is the best registry for software vendors distributing to customers?

Software vendors distributing commercial applications to external customers should use purpose-built registries like [Distr](/docs/registry/), which provide customer-specific access controls, usage analytics, license management, and support for self-managed and [air-gapped](/glossary/air-gapped-meaning/) customer deployments. Standard internal registries aren't built for that.
