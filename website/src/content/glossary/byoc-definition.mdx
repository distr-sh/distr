...
faq:
  ...
  - question: Does BYOC work with air-gapped environments?
    answer: 'Standard BYOC needs connectivity for vendor control plane access. True [air-gapped](/glossary/air-gapped-meaning/) deployments sit at the other end of the [self-hosted spectrum](/blog/self-hosted-spectrum/): fully customer-operated, offline updates, no vendor access.'
