...
faq:
  ...
  - question: Does BYOC work with air-gapped environments?
    answer: 'Standard BYOC needs internet connectivity for vendor control plane access. [Air-gapped](/glossary/air-gapped-meaning/) deployments need [self-hosted](/glossary/self-hosted-software/) or specialized deployment models with offline update mechanisms and local support tooling.'
...
BYOC sits between fully-managed [SaaS](/glossary/saas-definition/) (where everything runs in the vendor's infrastructure) and [self-hosted deployments](/glossary/self-hosted-software/) (where customers install and operate the software themselves). Customers keep control of cloud infrastructure, data location, and security policies. Vendors absorb the complexity of managing the software.
:::
...
BYOC, SaaS, and self-hosted are the three main deployment models, and picking the right one matters. For a detailed comparison, see our guide on [choosing between self-hosted, SaaS, and BYOC deployment models](/blog/self-hosted-vs-saas-vs-byoc/).
...
**[Self-Hosted](/glossary/self-hosted-software/):**
