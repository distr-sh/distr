...
faq:
  ...
  - question: Can on-premises software work without internet?
    answer: 'It can be designed to. On-prem is not air-gapped by default. True air-gap is a separate, stricter posture with offline packaging and no vendor access.'
  - question: What is the difference between on-premises and self-hosted?
    answer: 'Related, not identical. On-prem usually means the customer controls the environment (middle of the spectrum). Self-hosted is the umbrella for anything in the customer trust boundary, including BYOC and air-gap. See the self-hosted spectrum.'
...
| **Internet Requirement**     | Can be designed for offline / air-gap              | Requires internet connectivity                |
