...
Distr is an open-source software distribution platform built specifically for software vendors distributing applications to [self-hosted](/glossary/self-hosted-software/), BYOC, [on-premises](/glossary/on-premises-definition/), [air-gapped](/glossary/air-gapped-meaning/), and edge customer environments.
