...
type LicenseKey struct {
	...
	NotBefore              *time.Time      `db:"not_before"              json:"notBefore,omitempty"`
	ExpiresAt              *time.Time      `db:"expires_at"              json:"expiresAt,omitempty"`
	LastRevisedAt          *time.Time      `db:"last_revised_at"         json:"lastRevisedAt,omitempty"`
	OrganizationID         uuid.UUID       `db:"organization_id"         json:"-"`
	CustomerOrganizationID *uuid.UUID      `db:"customer_organization_id" json:"customerOrganizationId,omitempty"`
	LicenseTemplateID      *uuid.UUID      `db:"license_template_id"     json:"licenseTemplateId,omitempty"`
}
