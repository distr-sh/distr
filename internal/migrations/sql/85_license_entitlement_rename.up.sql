...
-- Rename UsageLicense -> LicenseKey
ALTER TABLE UsageLicense RENAME TO LicenseKey;
...
-- Rename LicenseKey indexes
DROP INDEX IF EXISTS idx_usagelicense_organization_id;
CREATE INDEX idx_licensekey_organization_id ON LicenseKey (organization_id);

DROP INDEX IF EXISTS idx_usagelicense_customer_organization_id;
